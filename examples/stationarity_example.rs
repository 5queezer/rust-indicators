...
fn main() {
    ...
    let white_noise = Array1::from(vec![
        0.1, -0.2, 0.3, -0.1, 0.4, -0.3, 0.2, -0.4, 0.1, 0.0, -0.1, 0.2, -0.3, 0.1, -0.2, 0.3,
        -0.1, 0.2, -0.3, 0.1, 0.05, -0.15, 0.25, -0.05, 0.35, -0.25, 0.15, -0.35, 0.05, -0.05,
    ]);
    ...
    println!(
        "  ADF Test:    statistic={:.4}, p-value={:.4}, stationary={}",
        adf_stat, adf_p, adf_stationary
    );
    println!(
        "  KPSS Test:   statistic={:.4}, p-value={:.4}, stationary={}",
        kpss_stat, kpss_p, kpss_stationary
    );
    println!(
        "  PP Test:     statistic={:.4}, p-value={:.4}, stationary={}",
