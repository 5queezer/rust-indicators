...
mod financial_series_tests {
    ...
    fn test_align_with_no_common_timestamps() {
        ...
        let timestamps2 = vec![base_time + Duration::minutes(2), base_time + Duration::minutes(3)];
    ...
    fn test_align_with_identical_timestamps() {
        let base_time = OffsetDateTime::now_utc();
        let timestamps = vec![base_time, base_time + Duration::minutes(1), base_time + Duration::minutes(2)];
